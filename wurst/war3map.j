...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'd116', 436.9, - 170.2, 231.125)
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'd110', 1216.0, 576.0, 270.000)
    ...
    set u=CreateUnit(p, 'd102', 448.0, 448.0, 270.000)
    set u=CreateUnit(p, 'd102', 1472.0, - 128.0, 270.000)
    set u=CreateUnit(p, 'd107', - 64.0, 448.0, 270.000)
