...
//===========================================================================
// 
// Island Troll Tribes v3.0n
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Thu Aug 23 00:37:55 2018
...
function CreateNeutralHostileBuildings takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h02J', - 2240.0, - 4672.0, 270.000)
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_revive_2=Rect(5632.0, - 5344.0, 6208.0, - 4928.0)
    ...
    set gg_rct_ship_BR_1=Rect(3584.0, - 1856.0, 3744.0, - 1696.0)
    ...
    set gg_rct_ship_R_2=Rect(3680.0, - 480.0, 3808.0, - 352.0)
    ...
    set gg_rct_ship_TL_1=Rect(- 3200.0, 1824.0, - 3072.0, 1920.0)
    ...
    set gg_rct_ship_TR_3=Rect(3680.0, 1632.0, 3808.0, 1760.0)
    ...
    set gg_rct_spawn_area_4_1=Rect(- 9664.0, - 9504.0, - 544.0, 928.0)
    set gg_rct_spawn_area_4_2=Rect(- 160.0, 704.0, 2880.0, 2688.0)
    set gg_rct_spawn_area_4_3=Rect(1632.0, - 1888.0, 3200.0, 704.0)
    set gg_rct_Thief_Bush_NE_A_In=Rect(1536.0, 7360.0, 1632.0, 7520.0)
    set gg_rct_Thief_Bush_NE_A_Out=Rect(1184.0, 7328.0, 1248.0, 7456.0)
    set gg_rct_Thief_Bush_NW_A_In=Rect(- 7808.0, 2112.0, - 7680.0, 2304.0)
