library LegacyInit initializer onInit
    private function LegacyInit takes nothing returns nothing
        ...
        call ExecuteFunc("InitTrig_Dark_Spear")
        call ExecuteFunc("InitTrig_Battle_Armor")
        call ExecuteFunc("InitTrig_Battle_Gloves")
        call ExecuteFunc("InitTrig_Anabolic_Boots")
        call ExecuteFunc("InitTrig_Battle_Axe")
        call ExecuteFunc("InitTrig_Poison_Spear")
        call ExecuteFunc("InitTrig_Refined_Poison_Spear")
        call ExecuteFunc("InitTrig_Ultra_Poison_Spear")
        ...
        call ExecuteFunc("InitTrig_ScrollCyclone")
        call ExecuteFunc("InitTrig_ScrollTsunami")
