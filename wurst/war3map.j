...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'd115', - 11338.7, - 9959.1, 313.436)
    set u=CreateUnit(p, 'd115', - 9681.1, - 11555.2, 356.968)
    set u=CreateUnit(p, 'd116', 308.5, - 224.1, 231.125)
    call SetUnitAcquireRange(u, 200.0)
    set u=CreateUnit(p, 'd115', - 9602.2, 10736.6, 335.641)
    set u=CreateUnit(p, 'd114', 10997.8, - 12177.1, 135.000)
    set u=CreateUnit(p, 'd114', - 11898.9, - 11915.7, 45.000)
    set t=CreateTrigger()
    call TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    call TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    call TriggerAddAction(t, function ItemTable000000_DropItems)
    set u=CreateUnit(p, 'd114', - 12162.9, 11005.1, 316.031)
    set u=CreateUnit(p, 'd114', 10880.7, 11008.1, 225.000)
    set t=CreateTrigger()
    call TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    call TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    call TriggerAddAction(t, function ItemTable000000_DropItems)
    set u=CreateUnit(p, 'd115', 8850.8, 10822.5, 174.284)
    set u=CreateUnit(p, 'd115', 10534.8, - 5082.3, 33.125)
    set u=CreateUnit(p, 'd115', 8533.9, - 11884.5, 73.647)
    set u=CreateUnit(p, 'd115', 3594.4, 10844.1, 56.200)
    set u=CreateUnit(p, 'd115', - 10657.6, - 5648.6, 307.022)
endfunction
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'd112', - 4352.0, - 11904.0, 270.000)
    set u=CreateUnit(p, 'd110', 1280.0, 384.0, 270.000)
    set u=CreateUnit(p, 'd107', - 1344.0, 6528.0, 270.000)
    set u=CreateUnit(p, 'd001', 3712.0, - 7104.0, 270.000)
    set u=CreateUnit(p, 'd120', 1600.0, - 10816.0, 270.000)
    set u=CreateUnit(p, 'd121', 1600.0, - 11072.0, 270.000)
    set u=CreateUnit(p, 'd122', 1600.0, - 11328.0, 270.000)
    set u=CreateUnit(p, 'd119', 1984.0, - 10816.0, 270.000)
    set u=CreateUnit(p, 'd106', - 6208.0, - 3520.0, 270.000)
    set u=CreateUnit(p, 'd106', 8000.0, - 4416.0, 270.000)
    set u=CreateUnit(p, 'd102', 832.0, 704.0, 270.000)
    set u=CreateUnit(p, 'd102', 832.0, - 1088.0, 270.000)
    set u=CreateUnit(p, 'd107', 448.0, 320.0, 270.000)
    set u=CreateUnit(p, 'd107', 1344.0, - 832.0, 270.000)
    set u=CreateUnit(p, 'd107', 5696.0, - 4224.0, 270.000)
    set u=CreateUnit(p, 'd108', - 704.0, - 5824.0, 270.000)
    set u=CreateUnit(p, 'd001', 9536.0, 7744.0, 270.000)
    set u=CreateUnit(p, 'd111', - 64.0, 0.0, 270.000)
    set u=CreateUnit(p, 'd106', 1728.0, 7360.0, 270.000)
    set u=CreateUnit(p, 'd106', - 7872.0, 2176.0, 270.000)
    set u=CreateUnit(p, 'd001', - 1600.0, 8896.0, 270.000)
    set u=CreateUnit(p, 'd001', - 9152.0, 192.0, 270.000)
    set u=CreateUnit(p, 'd001', 576.0, - 7104.0, 270.000)
    set u=CreateUnit(p, 'd001', 7232.0, - 5952.0, 270.000)
    set u=CreateUnit(p, 'd105', - 6336.0, 1984.0, 270.000)
    set u=CreateUnit(p, 'd001', - 5952.0, 3904.0, 270.000)
    set u=CreateUnit(p, 'd001', 4288.0, 8768.0, 270.000)
    set u=CreateUnit(p, 'd001', 8128.0, 5312.0, 270.000)
    set u=CreateUnit(p, 'd107', 832.0, - 8896.0, 270.000)
    set u=CreateUnit(p, 'd105', 6464.0, 1920.0, 270.000)
    set u=CreateUnit(p, 'd105', - 6784.0, - 7232.0, 270.000)
    set u=CreateUnit(p, 'd001', - 4928.0, - 6336.0, 270.000)
    set u=CreateUnit(p, 'd107', 7744.0, 7872.0, 270.000)
    set u=CreateUnit(p, 'd107', 5696.0, 320.0, 270.000)
    set u=CreateUnit(p, 'd107', - 6336.0, 6208.0, 270.000)
    set u=CreateUnit(p, 'd107', - 320.0, - 4544.0, 270.000)
    set u=CreateUnit(p, 'd108', 1024.0, - 2368.0, 270.000)
    set u=CreateUnit(p, 'd108', - 7808.0, 2624.0, 270.000)
    set u=CreateUnit(p, 'd108', - 6016.0, - 4032.0, 270.000)
    set u=CreateUnit(p, 'd117', 2560.0, - 10816.0, 270.000)
    set u=CreateUnit(p, 'd108', - 2560.0, - 2944.0, 270.000)
    set u=CreateUnit(p, 'd108', - 4416.0, 9536.0, 270.000)
    set u=CreateUnit(p, 'd108', 1088.0, 7104.0, 270.000)
    set u=CreateUnit(p, 'd108', 5184.0, 6848.0, 270.000)
    set u=CreateUnit(p, 'd108', 7872.0, - 3904.0, 270.000)
    set u=CreateUnit(p, 'd108', 5120.0, - 9856.0, 270.000)
    set u=CreateUnit(p, 'd101', - 7296.0, 7104.0, 270.000)
    set u=CreateUnit(p, 'd101', - 5312.0, 7104.0, 270.000)
    set u=CreateUnit(p, 'd103', 6208.0, 6144.0, 270.000)
    set u=CreateUnit(p, 'd103', 5056.0, 6080.0, 270.000)
    set u=CreateUnit(p, 'd109', 7744.0, - 4928.0, 270.000)
    set u=CreateUnit(p, 'd109', 3328.0, - 5696.0, 270.000)
    set u=CreateUnit(p, 'd108', - 3008.0, - 7936.0, 270.000)
    set u=CreateUnit(p, 'd107', - 9408.0, - 6720.0, 270.000)
    set u=CreateUnit(p, 'd106', - 2560.0, - 7488.0, 270.000)
    set u=CreateUnit(p, 'd118', 2304.0, - 10816.0, 270.000)
    set u=CreateUnit(p, 'd102', - 5056.0, 4416.0, 270.000)
    set u=CreateUnit(p, 'd123', 2368.0, - 11200.0, 270.000)
    set u=CreateUnit(p, 'd102', 8704.0, 8768.0, 270.000)
    set u=CreateUnit(p, 'd102', 8320.0, 576.0, 270.000)
    set u=CreateUnit(p, 'd102', 8576.0, 448.0, 270.000)
    set u=CreateUnit(p, 'd102', 6208.0, - 1216.0, 270.000)
    set u=CreateUnit(p, 'd102', 8768.0, - 8256.0, 270.000)
    set u=CreateUnit(p, 'd102', 1408.0, - 5440.0, 270.000)
    set u=CreateUnit(p, 'd102', 2112.0, - 3520.0, 270.000)
    set u=CreateUnit(p, 'd102', - 7616.0, 9152.0, 270.000)
    set u=CreateUnit(p, 'd102', - 8640.0, - 512.0, 270.000)
    set u=CreateUnit(p, 'd102', - 7872.0, - 5888.0, 270.000)
    set u=CreateUnit(p, 'd102', - 448.0, - 3264.0, 270.000)
    set u=CreateUnit(p, 'd100', - 7168.0, - 1664.0, 270.000)
    set u=CreateUnit(p, 'd100', - 2880.0, 7360.0, 270.000)
    set u=CreateUnit(p, 'd100', - 4288.0, 3264.0, 270.000)
    set u=CreateUnit(p, 'd100', 3136.0, 8064.0, 270.000)
    set u=CreateUnit(p, 'd100', 2368.0, 4224.0, 270.000)
    set u=CreateUnit(p, 'd100', 8256.0, - 3136.0, 270.000)
    set u=CreateUnit(p, 'd100', 3712.0, - 4928.0, 270.000)
    set u=CreateUnit(p, 'd100', - 6912.0, - 6720.0, 270.000)
    set u=CreateUnit(p, 'd100', - 8896.0, - 4480.0, 270.000)
    set u=CreateUnit(p, 'd104', - 8896.0, - 6848.0, 270.000)
    set u=CreateUnit(p, 'd104', - 2688.0, - 2560.0, 270.000)
    set u=CreateUnit(p, 'd001', - 5632.0, 1088.0, 270.000)
    set u=CreateUnit(p, 'd100', - 3456.0, - 4096.0, 270.000)
    set u=CreateUnit(p, 'd102', - 2880.0, 832.0, 270.000)
    set u=CreateUnit(p, 'd100', 1472.0, - 2240.0, 270.000)
    set u=CreateUnit(p, 'd001', - 3072.0, 576.0, 270.000)
    set u=CreateUnit(p, 'd001', - 4672.0, - 64.0, 270.000)
    set u=CreateUnit(p, 'd100', - 2112.0, 1472.0, 270.000)
    set u=CreateUnit(p, 'd100', 4416.0, 3776.0, 270.000)
    set u=CreateUnit(p, 'd001', 320.0, 5952.0, 270.000)
    set u=CreateUnit(p, 'd100', 2240.0, 6464.0, 270.000)
    set u=CreateUnit(p, 'd108', 7616.0, 3520.0, 270.000)
    set u=CreateUnit(p, 'd100', 9024.0, 6272.0, 270.000)
    set u=CreateUnit(p, 'd001', - 5696.0, 8768.0, 270.000)
    set u=CreateUnit(p, 'd100', - 1536.0, - 4096.0, 270.000)
    set u=CreateUnit(p, 'd108', - 5056.0, - 192.0, 270.000)
    set u=CreateUnit(p, 'd108', - 3840.0, - 9472.0, 270.000)
    set u=CreateUnit(p, 'd108', - 3328.0, - 9536.0, 270.000)
    set u=CreateUnit(p, 'd108', 7360.0, - 1088.0, 270.000)
    set u=CreateUnit(p, 'd108', - 5888.0, - 9024.0, 270.000)
    set u=CreateUnit(p, 'd108', - 1152.0, 1664.0, 270.000)
    set u=CreateUnit(p, 'd108', 9408.0, - 1344.0, 270.000)
    set u=CreateUnit(p, 'd105', 2304.0, - 6656.0, 270.000)
    set u=CreateUnit(p, 'd105', - 5440.0, - 2944.0, 270.000)
    set u=CreateUnit(p, 'd105', 1856.0, - 832.0, 270.000)
    set u=CreateUnit(p, 'd100', - 3008.0, - 6592.0, 270.000)
    set u=CreateUnit(p, 'd001', 8896.0, - 2112.0, 270.000)
    set u=CreateUnit(p, 'd102', - 960.0, 4800.0, 270.000)
    set u=CreateUnit(p, 'd105', 6080.0, - 5952.0, 270.000)
    set u=CreateUnit(p, 'd105', 2112.0, 7104.0, 270.000)
    set u=CreateUnit(p, 'd105', - 3136.0, 5568.0, 270.000)
endfunction
...
function CreateNeutralPassive takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'd113', - 12110.9, - 12102.2, 55.260)
    set u=CreateUnit(p, 'd113', - 12392.6, 11233.4, 317.760)
    set u=CreateUnit(p, 'd113', 11091.5, 11214.6, 225.980)
    set u=CreateUnit(p, 'd113', 11170.4, - 12327.9, 134.340)
endfunction
