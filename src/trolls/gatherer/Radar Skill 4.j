...
function Trig_radar_skill_4_Func001A takes nothing returns nothing
    if ( Trig_radar_skill_4_Func001Func001C() ) then
        call PingMinimapLocForForceEx( GetPlayersAllies(GetOwningPlayer(GetSpellAbilityUnit())), GetItemLoc(GetEnumItem()), 4.00, bj_MINIMAPPINGSTYLE_FLASHY, 0.00, 0.00, 100.00 )
    else
    endif
endfunction
