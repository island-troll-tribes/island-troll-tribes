...
if not hydraStarted then
    ...
    */
    set corpse_amt = 0
    call GroupEnumUnitsInRange(tGroup, GetUnitX(gg_unit_n019_0145) , GetUnitY(gg_unit_n019_0145) , 600, Condition(function MeatCorpse))
    ...
    if i[1] == ITEM_MUSHROOM and i[2] == ITEM_RIVER_ROOT and i[3] == ITEM_ELK_HIDE then
        ...
        call ForGroup(tGroup, function ConvertMeat)
