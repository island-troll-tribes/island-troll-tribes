...
call DisplayTText(GENERAL_COLOR+"Noob time is over. Now you will not be automatically revived when you die! You can still be revived if your team builds a |c00ff0000Spirit Ward|r"+GENERAL_COLOR+"!|r", 10)
call ModifyGateBJ( bj_GATEOPERATION_OPEN, gg_dest_ZTsx_3140 )
call init_KD_counter() // W3MMD TRACKING OF K/D
