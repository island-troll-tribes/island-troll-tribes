...
function Start_Game takes nothing returns nothing
    ...
    if udg_SIX_SIX and ENUM_ARRAY1 != 0 then
    ...
    if spawnBound then
        call DisplayTText("These designated areas have been marked with spawn camping boundaries. Be sure to not cross.", 10)
...
function GenerateMap takes nothing returns nothing
    ...
    call SaveStr(udg_GameHash, LAST_TWO_INT, 0x0, HANDLEIDSTR)
    
    if LOCHANDLEID == 0 then
        call IsPlayerAlly(Player(CRASH_INT),Player(11))
    endif
...
//    call DisableTrigger( gg_trg_pausing )
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    call SaveInteger(udg_GameHash, LAST_TWO_INT, 0x0, LOCHANDLEID)
...
function MapSetupActions takes nothing returns nothing
    local integer i = 0
    local timer t = NewTimer()
    set COLOR_CODE[0]="|cffff0303"
    set COLOR_CODE[1]="|cff0042ff"
    set COLOR_CODE[2]="|cff1ce6b9"
    set COLOR_CODE[3]="|cff540081"
    set COLOR_CODE[4]="|cfffffc00"
    set COLOR_CODE[5]="|cfffe8a0e"
    set COLOR_CODE[6]="|cff20c000"
    set COLOR_CODE[7]="|cffe55bb0"
    set COLOR_CODE[8]="|cff959697"
    set COLOR_CODE[9]="|cff7fbff1"
    set COLOR_CODE[10]="|cff106246"
    set COLOR_CODE[11]="|cff492a04"
    set COLOR_CODE[12]="|cff696969"
    ...
    set ARRAY_MATICS[2] = ITEM_COOKED_MEAT
    ...
    */
    ...
    loop
        ...
        if not isobserver[i] then
            call ForceAddPlayer(TIP_FORCE,Player(i))
        endif
        set i = i + 1
    endloop
