...
// Note to all users:
//
//  - the words 'the' and 'of' will be ommitted from
//    constants (with a few exceptions)
//
//  - some names aren't accurate to the ingame name, I and
//    others shall attempt to keep a list below with these
//    discrepancies but bear in mind if you are having
//    difficulty with a constant check here for its name
//      - ITEM_DISCO_DUCK_* -> ITEM_DD_*
//      - ITEM_GEM_KNOWLEDGE -> ITEM_GEM_OF_KNOWLEDGE
//      - UNIT_CRAFTMASTER_5000 -> UNIT_CRAFTMASTER
//
//#########################################################
...
library ID
	globals
		...
		constant integer UNIT_HUNTER_1   = 'CHU1'
		...
		constant integer UNIT_TRUE_FORM      = 'O00J'  // 'O00Z'
		constant integer UNIT_DRUID          = 'O01S'
		constant integer UNIT_CHICKEN_FORM   = 'O017'
		constant integer UNIT_ULTIMATE_FORM  = 'O010'
		constant integer UNIT_BEAST_MASTER_1 = 'CBM1'

		constant integer UNIT_SHAPESHIFTER_WOLF    = 'O00J'
		constant integer UNIT_SHAPESHIFTER_BEAR    = 'O008'
		constant integer UNIT_SHAPESHIFTER_PANTHER = 'O00Z'
		constant integer UNIT_SHAPESHIFTER_TIGER   = 'O01R'
		...
		constant integer UNIT_BOOSTER_1       = 'CBO1'
		constant integer UNIT_MASTER_HEALER   = 'O00S'
		constant integer UNIT_MASTER_HEALER_1 = 'CMH1'
		...
		constant integer UNIT_REPICK_TROLL        = 'Orpk'
		...
		constant integer UNIT_NETHER_DRAGON           = 'n00T'
		constant integer UNIT_RED_DRAGON              = 'n00K'
		...
		constant integer UNIT_WITCH_DOCTORS_HUT    = 'o005'
		constant integer UNIT_WORKSHOP             = 'o00I'
		constant integer UNIT_POWER_GENERATOR      = 'pwrg'
		constant integer UNIT_BONFIRE              = 'h001'
		...
		constant integer UNIT_TRADE_SHIP_4   = 'ts04'
		constant integer UNIT_TRADE_SHIP_5   = 'ts05'
		constant integer UNIT_TRADE_SHIP_6   = 'ts06'
		...
		constant integer SPELL_SELF_DESTRUCT = 'A0CJ'

		// Item Spells
		constant integer SPELL_DISEASE          = 'A041'
		constant integer SPELL_CURE_ALL_ITEM    = 'A05K'
		constant integer SPELL_SUPER_FORM_CAST  = 'A03N'
		constant integer SPELL_SONAR_COMPASS    = 'A02Q'
		constant integer SPELL_SUPERSUB_COURAGE = 'A0CW'

		// Spear Cast
		constant integer SPELL_SPEAR_CAST         = 'A0D0'
		constant integer SPELL_IRON_SPEAR_CAST    = 'A0D2'
		constant integer SPELL_STEEL_SPEAR_CAST   = 'A0D5'
		constant integer SPELL_POISON_SPEAR_CAST  = 'A0D3'
		constant integer SPELL_RPOISON_SPEAR_CAST = 'A0D4'
		constant integer SPELL_UPOISON_SPEAR_CAST = 'A0D6'
		constant integer SPELL_DARK_SPEAR_CAST    = 'A0D1'


		// Spear damage
        constant integer SPELL_DARK_SPEAR        = 'A05S'
        constant integer SPELL_RPOISON_SPEAR     = 'A00Z'
        constant integer SPELL_POISON_SPEAR      = 'A00Y'
        constant integer SPELL_IRON_SPEAR        = 'A01P'
        constant integer SPELL_UPOISON_SPEAR     = 'A00X'
        constant integer SPELL_STEEL_SPEAR       = 'A01Q'
        constant integer SPELL_SPEAR             = 'A00V'
        constant integer SPELL_BATTLE_SPEAR_CAST = 'A0EB'

        // Hunter Spells
        constant integer SPELL_DYSENTERY = 'A0CV'


		//#####################################################
		// Abilities (spells should be abilities)
		//#####################################################

		// Locust
		constant integer ABILITY_LOCUST              = 'Aloc'
		constant integer ABILITY_ASSASINATE          = 'A075'
		constant integer ABILITY_MEU_DUMMY           = 'AEU0'
		constant integer ABILITY_MEU_OMNIGATHERER    = 'AEU1'
		constant integer ABILITY_MEU_DEMENTIA_MASTER = 'AEU2'
		constant integer ABILITY_MEU_SAGE            = 'AEU3'
		constant integer ABILITY_MEU_SPY             = 'AEU4'
		constant integer ABILITY_MEU_ASSASSIN        = 'AEU5'
		constant integer ABILITY_INVULNERABLE        = 'Avul'
		constant integer ABILITY_SPEAR_RESIST        = 'ASPR'
		...
		constant integer BUFF_SPRINTING      = 'B01H'
		constant integer BUFF_SPEAR_INCOMING = 'B01M'
		constant integer BUFF_DYSENTERY      = 'B01N'
		...
		constant integer ITEM_MEDALLION_COURAGE   = 'I035'  // Conflict with Herb Recipe 6, appears removed?
		...
		constant integer ITEM_OMNICURE                = 'I033'
		...
		// Gatherer Salves
		constant integer ITEM_SALVE_ARMOR    = 'I052'
		constant integer ITEM_SALVE_HEALING  = 'I053'
		constant integer ITEM_SALVE_HYPNOSIS = 'I054'
		constant integer ITEM_SALVE_POISON   = 'I055'
		constant integer ITEM_SALVE_SPEED    = 'I056'
		...
		constant integer ITEM_SCROLL_SWIFTNESS        = 'I04Z'
		...
		constant integer ITEM_LOADED_THISTLES      = 'I030'
		constant integer ITEM_LOADED_DARK_THISTLES = 'I031'
		constant integer ITEM_LOADED_BONE          = 'I032'
		...
		constant integer ITEM_NULL                    = 'I034'
		constant integer ITEM_CANDY_CANE              = 'I057'
		constant integer ITEM_MECHANICAL_CRITTER      = 'mcri'
		constant integer ITEM_ALIGATOR_GOLD           = 'I057'
		constant integer ITEM_BLINK                   = 'I058'
		...
		constant integer DEST_CORAL             = 'B003'
	endglobals
endlibrary
