...
//
// Does not need any changing cuz it traps for 6v6
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
function Trig_Startup_6v6_Func002C takes nothing returns boolean
...
function Trig_Startup_6v6_Func003C takes nothing returns boolean
...
function Trig_Startup_6v6_Actions takes nothing returns nothing
    local unit u
    if ( Trig_Startup_6v6_Func002C() ) then
        set bj_forLoopAIndex = 1
        set bj_forLoopAIndexEnd = 6
        loop
            exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
            if ( Trig_Startup_6v6_Func002Func002Func001C() ) then
                set u=CreateUnitAtLoc(ConvertedPlayer(GetForLoopIndexA()),UNIT_ISLAND_TROLL, GetRandomLocInRect(gg_rct_revive_1), bj_UNIT_FACING )
        ...
        loop
            exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
            if ( Trig_Startup_6v6_Func002Func003Func001C() ) then
                set u=CreateUnitAtLoc(ConvertedPlayer(GetForLoopIndexA()),UNIT_ISLAND_TROLL, GetRandomLocInRect(gg_rct_revive_3), bj_UNIT_FACING )
                set udg_PUnits[( GetConvertedPlayerId(GetOwningPlayer(u)) - 1 )] = u
                call SuspendHeroXPBJ( false, u )
                call GroupAddUnitSimple( u, udg_trolls )
                call ModifyHeroSkillPoints( u, bj_MODIFYMETHOD_SET, 0 )
    ...
    if ( Trig_Startup_6v6_Func003C() ) then
